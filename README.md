...
* Only one member of the group should submit the repository URL.
* All group members have actively contributed and their roles are documented above.
* The live deployed site is linked above for evaluation.

Installation & Setup

Refer to the `backend/README.md` for detailed setup instructions, database configuration, and running the application locally.


Prepared for submission according to group assignment instructions.
